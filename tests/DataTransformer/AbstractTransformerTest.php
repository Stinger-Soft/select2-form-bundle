...
use ReflectionClass;
use StingerSoft\Select2FormBundle\BaseDoctrineTest;
use StingerSoft\Select2FormBundle\Entity\SelectableMultiIdentities;
use StingerSoft\Select2FormBundle\Entity\SelectableSingleIdentity;
...
abstract class AbstractTransformerTest extends BaseDoctrineTest {
	...
	protected function mockSelectableClassMetadata(): MockObject {
		...
		$cm->namespace = 'StingerSoft\Select2FormBundle\Tests\Entity\SelectableSingleIdentity';
		return $cm;
	}
	...
	protected function mockSelectableMultiKeyClassMetadata(): MockObject {
		...
		$cm->identifier = $identifier;
		$cm->namespace = 'StingerSoft\Select2FormBundle\Tests\Entity\SelectableMultiIdentities';
		return $cm;
	}
}