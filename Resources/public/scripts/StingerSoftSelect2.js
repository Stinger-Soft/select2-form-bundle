...
if (typeof $.fn.select2 !== 'undefined' && typeof $.fn.select2.prototype.constructor.amd !== 'undefined' && $.fn.select2.prototype.constructor.amd.require._defined["select2/selection/search"] !== 'undefined') {
	var originalSelect2ResizeSearch = $.fn.select2.prototype.constructor.amd.require._defined["select2/selection/search"].prototype.resizeSearch;

	$.fn.select2.prototype.constructor.amd.require._defined["select2/selection/search"].prototype.resizeSearch = function () {
		"use strict";
		setTimeout(jQuery.proxy(originalSelect2ResizeSearch, this), 100);
	};
}
...
StingerSoftSelect2.init = function (selector, options) {
	...
	if (!canReportValidity && $field.prop('required')) {
		$field.on('invalid', function () {
			var $formGroup;
			var $closest = $formGroup = $field.closest('.form-group');
			if ($formGroup.length === 0) {
				$closest = $field.closest('.select2-parent');
			}
...
StingerSoftSelect2.matcher.combat = jQuery.fn.select2.amd.require('select2/compat/matcher');
...
StingerSoftSelect2.matcher.internal.diacritics = jQuery.fn.select2.amd.require('select2/diacritics');
