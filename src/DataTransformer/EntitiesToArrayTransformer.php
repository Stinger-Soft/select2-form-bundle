...
class EntitiesToArrayTransformer implements DataTransformerInterface {
	 ...
	 * @param string $class
	 */
	public function __construct(protected ChoiceLoaderInterface $choiceList, protected EntityManager $em, protected string $class) {
	 ...
	 */
	private function getIdentifierValues(object $entity): array {
